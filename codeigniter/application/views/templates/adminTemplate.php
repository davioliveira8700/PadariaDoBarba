...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="https://c8.alamy.com/compes/2g4nf77/lindo-icono-de-hombre-con-barba-caricatura-de-hombre-barbudo-icono-vector-para-diseno-web-aislado-sobre-fondo-blanco-2g4nf77.jpg" alt="">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url();?>index.php/produtos">
          <i class="bi bi-grid"></i>
          <span>produtos</span>
        </a>
