            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Entre com a sua conta</h5>
                    <p class="text-center small">Digite o usuario e senha</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="/index.php/login/validalogin">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Por favor diigite seu email.</div>
                      </div>
                    </div>
